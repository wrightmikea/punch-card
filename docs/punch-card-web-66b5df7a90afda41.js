...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbindgen_cast_81d909efc2587b76 = function(arg0, arg1) {
        // Cast intrinsic for `Closure(Closure { dtor_idx: 214, function: Function { arguments: [Ref(NamedExternref("Event"))], shim_idx: 215, ret: Unit, inner_ret: Some(Unit) }, mutable: false }) -> Externref`.
        const ret = makeClosure(arg0, arg1, 214, __wbg_adapter_6);
        return ret;
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('punch-card-web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
